...
####### than 2-hours it will kill the rsynnc process
#######
...
#######
####### Then, edit the cronjobs using "crontab -e" command, adding the following 
####### line in order to execute the syncronization every 5 minutes.
#######
